...
allowVolumeExpansion: true
----
Se è già stata creata una classe di archiviazione senza questa opzione, è possibile modificare semplicemente la classe di archiviazione esistente utilizzando `kubectl edit storageclass` per consentire l'espansione del volume.
